                              ...
                              <tbody className="divide-y divide-gray-200">
                                 {service.products.map((p, i) => (
                                    <tr key={i} className="hover:bg-gray-50">
                                       <td className="px-6 py-4 font-semibold text-gray-900">{p.productName}</td>
                                       <td className="px-6 py-4 text-gray-700">{p.use}</td>
                                       <td className="px-6 py-4 text-gray-700">{p.solidContent}</td>
                                       <td className="px-6 py-4 text-gray-700">{p.graphite}</td>
                                    </tr>
                                 ))}
                              </tbody>
                           </table>
